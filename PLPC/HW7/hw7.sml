...
(* add shifts for expressions of the form Shift(deltaX, deltaY, exp *)
...
(* right now this only checks, values, it need to return the entire expression *)
(* need to do case for each type of expression *)
(* geom_exp -> geom_exp *)
fun preprocess_prog (gExpArg) =
    case gExpArg of
	...
	|	Intersect (sub1, sub2) => Intersect(preprocess_prog sub1, preprocess_prog sub2)
